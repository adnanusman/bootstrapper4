...
// Project related.
var project                 = 'LifeQuote Landing Pages'; // Project Name.
var projectURL              = 'lifequote.test'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
...
var bugReport               = 'https://tacticalengine.com/contact/'; // Where can users report bugs.
var lastTranslator          = 'Adnan Usman <adnan@tacticalengine.com>'; // Last translator Email ID.
var team                    = 'Tactical Engine <admin@tacticalengine.com>'; // Team's Email ID.

// Style related.
var styleSRC                = './assets/css/style.css'; // Path to main .css file.
var styleDestination        = './css/'; // Path to place the compiled CSS file.
// Default set to root folder.

// JS Vendor related.
var jsVendorSRC             = './assets/js/*.js'; // Path to JS vendor folder.
var jsVendorDestination     = './js/'; // Path to place the compiled JS vendors file.
var jsVendorFile            = 'custom'; // Compiled JS vendors file name.
...
// Watch files paths.
var styleWatchFiles         = './assets/css/**/*.css'; // Path to all *.css files inside css folder and inside them.
